...
> **[2026-04-06 기술 스택 변경]**
> React → HTML/CSS/JS + Jinja2 로 변경
> 사유: Python 부트캠프 과정에 React 포함 없음, 팀원 모두 미숙련
...
| 유동주 | 취업반 | 팀원 | mockup·ERD·개발과정.md·React 모바일 (EC2 단독) |
...
- Python 가상환경: `C:\Portfolio\Owner_Bot\myEnv`
- DB: SQLite (개발용)
...
3. 개발 방향 확정
   ...
   - 가상환경: myEnv (C:\Portfolio\Owner_Bot\myEnv)
...
> 마지막 업데이트: 2026-04-06 (기술 스택 확정) | 작성: 유동주 + Claude AI
